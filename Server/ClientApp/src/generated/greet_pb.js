...
goog.exportSymbol('proto.greet.ByteReply', null, global);
 ...
 * @constructor
 */
proto.greet.ByteReply = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.greet.ByteReply, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.greet.ByteReply.displayName = 'proto.greet.ByteReply';
}
 ...
 * @return {!Object}
 */
proto.greet.ByteReply.prototype.toObject = function(opt_includeInstance) {
  return proto.greet.ByteReply.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.greet.ByteReply} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.greet.ByteReply.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.greet.ByteReply}
 */
proto.greet.ByteReply.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.greet.ByteReply;
  return proto.greet.ByteReply.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.greet.ByteReply} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.greet.ByteReply}
 */
proto.greet.ByteReply.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.greet.ByteReply.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.greet.ByteReply.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.greet.ByteReply} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.greet.ByteReply.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.greet.ByteReply.prototype.getMessage = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 * @return {string}
 */
proto.greet.ByteReply.prototype.getMessage_asB64 = function() {
 ...
 * @return {!Uint8Array}
 */
proto.greet.ByteReply.prototype.getMessage_asU8 = function() {
 ...
 * @return {!proto.greet.ByteReply} returns this
 */
proto.greet.ByteReply.prototype.setMessage = function(value) {
